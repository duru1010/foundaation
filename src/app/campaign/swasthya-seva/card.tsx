...
const DonationDashboard = () => {
  ...
  // Real data for Arogya Initiative
  const raised = 50000;
  const goal = 85000000;
  const donors = 3;
  const benefited = 0;
  ...
  return (
    <div className="h-[600px] bg-purple-50 flex flex-col items-center justify-center p-6 font-sans">
      <h1 className="text-5xl font-black text-zinc-900 tracking-tighter">
            AROGYA<span className="text-purple-600"></span>
          </h1>
      ...
      <div className="w-full max-w-5xl flex flex-col lg:flex-row items-stretch shadow-[0_40px_80px_-20px_rgba(124,58,237,0.15)] rounded-[2.5rem] overflow-hidden bg-white border border-purple-100">
        ...
        <div className="w-full lg:w-5/12 bg-purple-600 p-8 md:p-10 flex flex-col justify-between relative overflow-hidden text-white">
          ...
          >
            <span className="text-purple-200 font-bold uppercase tracking-widest text-[10px]">PET/CT Mobile Van</span>
            <h2 className="text-3xl font-black mt-2 leading-tight">Early Detection Saves Lives</h2>
            <p className="mt-3 text-purple-100 leading-relaxed text-sm opacity-90">
              Providing free or subsidized PET/CT diagnostics to underserved rural communities in Pune and beyond.
            </p>
          </motion.div>
          ...
          <div className="mt-12 relative z-10 space-y-5">
            <div className="flex justify-between items-end border-b border-white/10 pb-4">
              ...
              <div className="text-right">
                ...
                <p className="font-bold text-sm">₹8.5 Cr</p>
              </div>
            </div>
            ...
            <div className="flex gap-8 pt-2">
               ...
               <div>
                 ...
                 <p className="text-sm font-bold">Pune, Maharashtra</p>
               </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-7/12 p-8 md:p-12 bg-white flex flex-col justify-center">
          ...
          >
            <div>
              <h2 className="text-3xl font-black text-zinc-900 tracking-tight">Support Arogya</h2>
              <p className="text-zinc-400 text-sm mt-1 font-medium italic">Your contribution fuels the journey toward a cancer-free future.</p>
            </div>

            <div className="space-y-4">
              <label className="text-[10px] font-black text-purple-600 uppercase tracking-widest">Funding Amount</label>
    ...
    >
      ...
      <svg className="w-5 h-5 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M14 5l7 7m0 0l-7 7m7-7H3" />
              ...
              <p className="text-center text-[10px] text-zinc-400 mt-5 uppercase font-bold tracking-[0.2em]">Partnered with Swachetna Foundation</p>
            </div>
          </motion.div>
        </div>
      </div>
