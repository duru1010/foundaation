    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#F3F0FF] p-6 lg:p-12">
      ...
      <div className="mb-12 text-center max-w-3xl">
        ...
        <p className="text-xl text-purple-600 font-medium">
          Bridging the gap to quality healthcare for a self-reliant society.
        </p>
      </div>
      ...
      <div className="flex w-full max-w-7xl min-h-[850px] overflow-hidden rounded-[50px] bg-white p-6 shadow-2xl md:flex-row flex-col-reverse">
        ...
        <div className="flex flex-col justify-center px-10 py-16 md:w-1/2 lg:px-20">
          ...
          <h4 className="text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] tracking-tighter">
            AROGYA: <br/>
            <span className="text-purple-600">Wellness for All</span>
          </h4>
          
          <p className="mt-8 text-lg text-gray-600 leading-relaxed">
            At Swachetna Foundation, we believe good health is the foundation of a strong nation. 
            <strong> Arogya</strong> is a people-centered initiative bringing preventive, diagnostic, 
            and curative care to the doorsteps of the most marginalized.
          </p>

          {/* Core Focus Points */}
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {[
              { title: "Free Health Camps", desc: "Medical check-ups in urban slums, rural, and tribal regions." },
              { title: "Cancer Screening", desc: "Advanced screenings brought directly to underprivileged doorsteps." },
              { title: "Medical Aid", desc: "Support for essential medicines, diagnostic tests, and procedures." },
              { title: "Mental Wellness", desc: "Counseling sessions specifically for women and youth." },
              { title: "Nutrition Support", desc: "Focused care for children and pregnant women." },
              { title: "Clinical Networks", desc: "Collaborations with hospitals and health professionals." }
            ].map((item, index) => (
        ...
        <div className="group relative flex flex-col justify-end overflow-hidden rounded-[40px] bg-[#6D28D9] md:w-1/2 min-h-[500px] cursor-pointer">
          ...
          <Image 
            src="/WhatsApp Image 2026-04-28 at 3.39.06 PM (6).jpeg" // Replace with your actual image path
            alt="Arogya Wellness Initiative"
            fill
          ...
          <div className="absolute inset-0 flex items-center justify-center z-0 group-hover:opacity-0 transition-opacity duration-500">
             ...
             <p className="absolute text-purple-200 font-serif italic text-8xl opacity-10 select-none uppercase">Arogya</p>
          </div>
        </div>
