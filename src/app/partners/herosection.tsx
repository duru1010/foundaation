...
const SwechetnaHero = () => {
  return (
    <section className="relative w-full bg-white font-sans text-black overflow-hidden">
      ...
      {/* MAIN CONTENT */}
      <div className="max-w-7xl mx-auto w-full px-5 md:px-6 lg:px-12 py-10 md:py-4 relative z-10">
        
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr,0.8fr] items-center gap-10 lg:gap-0">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 1, delay: 0.2 }}
            className="relative flex justify-center lg:hidden mt-8"
          >
            <div className="relative group p-1.5 border border-[#6d62e5]/10 rounded-[8rem] bg-white shadow-xl shadow-[#6d62e5]/5">

              {/* GLOW */}
              <div className="absolute inset-0 rounded-[8rem] bg-purple-500/20 blur-xl opacity-60"></div>

              {/* BORDER */}
              <div className="absolute inset-0 rounded-[8rem] border border-purple-300 opacity-70"></div>
          ...
          >
            <div className="space-y-4 md:space-y-3">
              ...
              >
                ...
                <span className="text-[#6d62e5] relative inline-block">
                  Foundation
            ...
            >
              <svg
                viewBox="0 0 100 100"
                className="w-16 h-16 text-[#6d62e5]/20 fill-current"
              >
                <path d="M50 0 L55 35 L90 15 L70 45 L100 50 L70 55 L90 85 L55 65 L50 100 L45 65 L10 85 L30 55 L0 50 L30 45 L10 15 L45 35 Z" />
              </svg>
            </motion.div>
