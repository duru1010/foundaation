  ...
  return (
    <section className="relative w-full h-[600px] flex items-center overflow-hidden bg-[#F3E8FF]">
      ...
      <div className="container mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-8 items-center relative z-10">
        ...
        {/* Right Content: Circular Image with Slide-in AND 360 Rotation */}
        <div className="relative flex justify-center items-center h-full">
          ...
          >
            {/* This inner motion.div handles the infinite rotation 
                without interfering with the slide-up entrance animation 
            */}
            <motion.div 
              animate={{ rotate: 360 }}
              transition={{ 
            ...
            >
              <img 
                src="/54096a848147e0d00f3e7a7f02b76bd5.jpg" 
