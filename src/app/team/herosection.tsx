...
const SwechetnaLeadershipHero = () => {
  return (
    <section className="relative w-full min-h-[550px] lg:h-[60vh] bg-white font-sans text-black overflow-hidden flex flex-col">
      
      {/* ================= TOP BRANDING ================= */}
      <div className="pt-6 md:pt-8 flex flex-col items-center justify-center z-20 px-4">
        <div className="flex items-center gap-3 text-center">
          <span className="text-[9px] md:text-[11px] font-medium tracking-[0.2em] uppercase text-gray-400">
            Executive Panel
          </span>

          <div className="h-4 w-px bg-purple-200 mx-1 hidden md:block" />

          <span className="text-[9px] md:text-[10px] font-black tracking-tighter uppercase text-purple-600 leading-tight">
            Swechetna <br /> Council
          </span>
        </div>
      </div>
   ...
   <div className="relative flex justify-center items-start pt-4 md:pt-6 h-[220px] md:h-[280px]">
        {/* ================= STEPPED BACKGROUND ================= */}
        <div className="absolute top-0 flex flex-col items-center w-full px-2 md:px-4">

          <div className="w-full max-w-[1100px] h-[28px] md:h-[40px] border-x border-b border-gray-50 bg-[#F9F7FF]" />

          <div className="w-[92%] max-w-[900px] h-[28px] md:h-[40px] border-x border-b border-gray-100 bg-[#F0E9FF]" />

          <div className="w-[84%] max-w-[700px] h-[28px] md:h-[40px] border-x border-b border-gray-100 bg-[#E1D4FF]" />

          <div className="w-[74%] max-w-[550px] h-[28px] md:h-[40px] border-x border-b border-gray-200 bg-[#C8B1FF]" />

          <div className="w-[60%] max-w-[400px] h-[36px] md:h-[50px] border-x border-b border-gray-200 bg-[#9B7CFF]" />

          <div className="w-[40%] max-w-[250px] h-[45px] md:h-[60px] bg-gradient-to-b from-[#7C5CFF] to-[#5A3DFF]" />
        ...
        >
          ...
          >
            <svg
              ...
              height="120"
              viewBox="0 0 200 200"
              className="md:w-[160px] md:h-[160px] drop-shadow-[0_25px_25px_rgba(124,92,255,0.25)]"
            >
              <path
                d="M100 100L30 40C60 10 140 10 170 40L100 100Z"
                fill="url(#iron-top)"
              />

              <path
                d="M100 100L170 160C195 130 195 70 170 40L100 100Z"
                fill="url(#iron-right)"
              />

              <path
                d="M100 100L30 160C5 130 5 70 30 40L100 100Z"
                fill="url(#iron-left)"
              />
      ...
      {/* ================= HEADING SECTION ================= */}
     <div className="max-w-7xl mx-auto w-full px-5 md:px-6 lg:px-12 pb-10 md:pb-12 z-20 -mt-6 md:-mt-6">
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-8 lg:gap-24 items-center md:items-end">
          ...
          >
            <p className="text-purple-600 font-bold text-[9px] md:text-[10px] uppercase tracking-[0.35em] md:tracking-[0.4em] mb-2">
              Visionaries & Architects
            </p>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tighter text-black leading-[0.9]">
              Swechetna <br />
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="space-y-5 md:pl-10 lg:pl-20 text-center md:text-left"
          >
            <div className="space-y-3">
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold tracking-tight uppercase">
                Strategic Core
              </h2>

              <p className="text-gray-500 text-sm lg:text-base font-medium leading-relaxed max-w-md mx-auto md:mx-0">
                Empowering the ecosystem through modular AI frameworks and decentralized governance.
              </p>
            </div>

            <button className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-purple-600 group transition-all">
              Meet the board
      ...
      <div className="absolute inset-0 rounded-2xl bg-purple-500/20 blur-xl opacity-60 transition duration-500" />

      <div className="absolute inset-0 rounded-2xl border border-purple-300 opacity-70 transition" />
    </section>
  );
};
