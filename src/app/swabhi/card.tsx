    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#F3F0FF] p-6 lg:p-12">
      ...
      <div className="mb-12 text-center max-w-3xl">
        ...
        <p className="text-xl text-purple-600 font-medium">
          Restoring dignity and health through transformative hygiene care.
        </p>
      </div>
      ...
      <div className="flex w-full max-w-7xl min-h-[850px] overflow-hidden rounded-[50px] bg-white p-6 shadow-2xl md:flex-row flex-col-reverse">
        ...
        <div className="flex flex-col justify-center px-10 py-16 md:w-1/2 lg:px-20">
          ...
          <h4 className="text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] tracking-tighter">
            SWABHIMAN: <br/>
            <span className="text-purple-600">Hygiene Care for Women</span>
          </h4>
          
          <p className="mt-8 text-lg text-gray-600 leading-relaxed">
            Meaning <strong>dignity and self-respect</strong>, SWABHIMAN is a transformative initiative aimed at promoting 
            menstrual hygiene, health awareness, and dignity for women and adolescent girls in underserved communities.
          </p>

          {/* Core Focus Points */}
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {[
              { title: "Hygiene Awareness", desc: "Peer-led education and school workshops on menstrual health." },
              { title: "Eco-friendly Access", desc: "Distribution of affordable sanitary products via local entrepreneurs." },
              { title: "Breaking Taboos", desc: "Fostering open conversations to eliminate deep-rooted stigma." },
              { title: "Safe Sanitation", desc: "Improving clean water and facility access in rural schools." },
              { title: "Bodily Autonomy", desc: "Empowering girls with reproductive health and self-care knowledge." },
              { title: "Livelihood Creation", desc: "Opportunities for women in sanitary product production." }
            ].map((item, index) => (
        ...
        <div className="group relative flex flex-col justify-end overflow-hidden rounded-[40px] bg-[#6D28D9] md:w-1/2 min-h-[500px] cursor-pointer">
          ...
          <div className="relative z-20 p-12 lg:p-16 text-white">
            ...
            <p className="text-purple-100 opacity-90 text-base max-w-sm">
              Menstruation is a natural process, not a barrier. Join us in breaking the silence and providing safe health solutions for every woman.
            </p>
          ...
          <div className="absolute inset-0 flex items-center justify-center z-0 group-hover:opacity-0 transition-opacity duration-500">
             ...
             <p className="absolute text-purple-200 font-serif italic text-8xl opacity-10 select-none uppercase">Swabhiman</p>
          </div>
        </div>
