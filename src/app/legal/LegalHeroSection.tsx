  ...
  return (
    <main className="relative w-full h-[400px] bg-white overflow-hidden flex items-end p-12 md:p-16 lg:px-24 selection:bg-purple-100">
      ...
      <div className="relative z-10 w-full max-w-6xl">
        ...
        >
          <h1 className="text-[44px] md:text-[68px] font-bold tracking-[-0.05em] text-[#2D2140] leading-[1.0] antialiased">
            Legal and Financial <br />
            <motion.span 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 1, delay: 1 }}
              className="text-purple-700 font-semibold text-[40px] md:text-[60px] leading-[1.1]"
            >
