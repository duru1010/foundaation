...
const AnnadataCard = () => {
  return (
    <div className="flex min-h-[250px] flex-col items-center justify-center bg-[#F3F0FF] p-6 lg:p-12">
      ...
      <div className="mb-12 text-center max-w-3xl">
        ...
        <p className="text-xl text-purple-600 font-medium">
          Annadata: Holistic Welfare and Empowerment of Farmers
        </p>
      </div>

      {/* MAIN CARD CONTAINER */}
      <div className="flex w-full max-w-6xl min-h-[450px] overflow-hidden rounded-[50px] bg-white p-6 shadow-2xl md:flex-row flex-col-reverse">
        ...
        <div className="flex flex-col justify-center px-10 py-16 md:w-1/2 lg:px-20">
          ...
          <div className="mb-6 inline-flex w-fit items-center rounded-full bg-purple-100 px-4 py-2 text-sm font-bold text-purple-700 uppercase tracking-widest">
            Farmer Welfare Initiative
          </div>

          <h4 className="text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] tracking-tighter">
            ANNADATA: <br/>
            <span className="text-purple-600">Farmer Welfare</span>
          </h4>
          
          <p className="mt-8 text-lg text-gray-600 leading-relaxed">
            Recognizing farmers as the backbone of India, <strong>ANNADATA</strong> focuses on enhancing livelihoods, dignity, and resilience through direct market linkages and sustainable agrarian solutions.
          </p>

          {/* Core Focus Points */}
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {[
              { title: "Fair Market Access", desc: "Direct buyer linkages to reduce dependency on intermediaries." },
              { title: "Modern Practices", desc: "Training in sustainable farming and post-harvest management." },
              { title: "Value Addition", desc: "Support for certification, packaging, and global branding." },
              { title: "Social Security", desc: "Financial literacy and connection to credit and insurance." },
              { title: "Mental Well-being", desc: "Awareness drives and community stress management networks." },
              { title: "Climate Resilience", desc: "Building resilience through diversification and allied activities." }
            ].map((item, index) => (
        ...
        <div className="group relative flex flex-col justify-end overflow-hidden rounded-[40px] bg-[#6D28D9] md:w-1/2 min-h-[500px] cursor-pointer">
          ...
          <Image 
            src="/WhatsApp Image 2026-04-28 at 3.39.06 PM (10).jpeg" 
            alt="Annadata Farmer Welfare"
            fill
          ...
          <div className="relative z-20 p-12 lg:p-16 text-white">
            <h3 className="text-3xl lg:text-4xl font-bold leading-tight mb-4">
              Building an Aatmanirbhar agrarian future.
            </h3>
            
            <p className="text-purple-100 opacity-90 text-base max-w-sm">
              From food providers to economically empowered leaders. Join us in securing the social and financial future of our farmers.
            </p>
          ...
          <div className="absolute inset-0 flex items-center justify-center z-0 group-hover:opacity-0 transition-opacity duration-500">
             ...
             <p className="absolute text-purple-200 font-serif italic text-8xl opacity-10 select-none">ANNADATA</p>
          </div>
        </div>
