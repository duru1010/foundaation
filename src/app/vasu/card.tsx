    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#F3F0FF] p-6 lg:p-12">
      ...
      <div className="mb-12 text-center max-w-3xl">
        ...
        <p className="text-xl text-purple-600 font-medium">
          Nurturing a greener, cleaner, and more sustainable future.
        </p>
      </div>
      ...
      <div className="flex w-full max-w-7xl min-h-[850px] overflow-hidden rounded-[50px] bg-white p-6 shadow-2xl md:flex-row flex-col-reverse">
        ...
        <div className="flex flex-col justify-center px-10 py-16 md:w-1/2 lg:px-20">
          ...
          <h4 className="text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] tracking-tighter">
            VASUDHRAM: <br/>
            <span className="text-purple-600">Harmony with Nature</span>
          </h4>
          
          <p className="mt-8 text-lg text-gray-600 leading-relaxed">
            Derived from <strong>"Vasundhara" (Mother Earth)</strong>, VASUDHRAM is Swachetna Foundation's commitment to protecting natural resources and empowering communities to thrive in balance with the planet.
          </p>

          {/* Core Focus Points */}
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {[
              { title: "Sustainable Farming", desc: "Organic farming and regenerative practices to preserve soil health." },
              { title: "Afforestation", desc: "Tree plantation and watershed development to combat climate change." },
              { title: "Climate Resilience", desc: "Training communities in climate-smart resource management." },
              { title: "Waste Awareness", desc: "Reducing pollution through recycling, upcycling, and eco-education." },
              { title: "Water Conservation", desc: "Rainwater harvesting and efficient, modern irrigation systems." },
              { title: "Youth Engagement", desc: "Fostering environmental stewardship from a young age." }
            ].map((item, index) => (
        ...
        <div className="group relative flex flex-col justify-end overflow-hidden rounded-[40px] bg-[#6D28D9] md:w-1/2 min-h-[500px] cursor-pointer">
          ...
          <div className="relative z-20 p-12 lg:p-16 text-white">
            ...
            <p className="text-purple-100 opacity-90 text-base max-w-sm">
              We aim to restore degraded ecosystems and empower people to adopt practices that let both humanity and the planet thrive.
            </p>
          ...
          <div className="absolute inset-0 flex items-center justify-center z-0 group-hover:opacity-0 transition-opacity duration-500">
             ...
             <p className="absolute text-purple-200 font-serif italic text-7xl lg:text-8xl opacity-10 select-none uppercase">Vasudhram</p>
          </div>
        </div>
