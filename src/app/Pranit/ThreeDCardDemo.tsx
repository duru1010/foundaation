...
export function PranitvaCampaignCard() {
  return (
    <div className="py-10 flex flex-col items-center justify-center">
      ...
      <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-black to-[#7C3AED] mb-4 uppercase tracking-tight">
        PRANITVA: Campaign
      </h2>
      ...
      <CardContainer className="inter-var">
        <CardBody className="bg-[#FFFDFB] relative group/card dark:hover:shadow-2xl dark:hover:shadow-purple-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-2xl p-6 border transition-all">
          ...
          <CardItem
            as="p"
            translateZ="60"
            className="text-[#7C3AED] text-sm max-w-sm mt-2 dark:text-neutral-300 font-medium leading-relaxed"
          >
            A heartfelt campaign focused on the welfare, care, and dignity of animals and birds, especially our beloved Gau Mata (cows).
          </CardItem>

          {/* Image */}
          <CardItem translateZ="100" className="w-full mt-4">
            <img
              src="/your-pranitva-image.jpg" // Replace with your actual image path
              height="1000"
              width="1000"
              className="h-64 w-full object-cover rounded-xl group-hover/card:shadow-xl transition-all duration-500"
              alt="Goshala Seva Campaign"
            />
          </CardItem>
          ...
          <div className="flex justify-between items-center mt-10">
            ...
            <CardItem translateZ={40} className="flex flex-col items-end">
              ...
              <span className="text-sm font-bold text-[#7C3AED] font-mono">₹5 Lakhs</span>
            </CardItem>
          </div>
